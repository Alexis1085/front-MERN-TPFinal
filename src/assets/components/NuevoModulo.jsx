...
const NuevoModulo = () => {
    ...
    const agregarModulo = (formData, e) => {
        ...
        //console.log(URL);
        try {
            axios.post(`${URL}/admin/modulos`, formData)
            .then(response => {
                if (response.data.moduloAgregado) {
    ...
    return(
        <div className="formContainer">
            ...
            <form onSubmit={handleSubmit(agregarModulo)}>
                <fieldset>
                ...
                <div className="botonera">
                    ...
                    <button type="submit" className="button">Agregar Módulo</button>
                </div>
            </form>
        </div>
    )
